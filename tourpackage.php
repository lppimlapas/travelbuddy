...
<div class="w3-top">
  <div class="w3-bar w3-white w3-card" id="myNavbar">
    ...
    <div class="w3-right w3-hide-small">
      ...
      <button class="w3-padding-extralarge w3-button w3-black" title="More" >GO TO WEBSITE <i class="fa fa-caret-down"></i></button>     
      <div class="w3-dropdown-content w3-bar-block w3-card-4">
        <a href="signup.php" class="w3-bar-item w3-button">SIGN UP</a>
        <a href="signin.php" class="w3-bar-item w3-button">SIGN IN</a>
        <a href="adminsignin.php" class="w3-bar-item w3-button">ADMIN SIGN IN</a>
      </div>
      </div>
...
<nav class="w3-sidebar w3-bar-block w3-black w3-card w3-animate-left w3-hide-medium w3-hide-large" style="display:none" id="mySidebar">
  ...
  <a href="adminsignin.phpl" onclick="w3_close()" class="w3-bar-item w3-button">ADMIN SIGN IN</a>
</nav>
...
<div class="container" style="width:100%;">
  <?php
    ...
    ?>
          ...
          <div>
          <form method="post" action="signin.php?action=add&id=<?php echo $row["id"]; ?>">
         
            <!--<div class="mypanel" id="fblock" align="center" ;>-->
            <div class="w3-quarter">
              ...
              <input type="submit" name="reserve" style="margin-top:5px;" class="btn btn-primary btn-lg" id="btorder" value="Reserve Now!">
              </br>
              </br>
             </div>            
